  ...
  template: `
    <div class="container" style="margin-bottom:500px">
      ...
      <p [ngClass]="{ 'mau-chu': mauChu, 'font-chu': fontChu }">
        ...
        obcaecati provident voluptatem. Quisquam dolorem voluptates, aspernatur
        ipsum vitae, incidunt nobis sint temporibus commodi quo adipisci
        pariatur accusantium ea omnis error!
      </p>
      <table class="table">
        <thead>
          <tr>
      ...
      <div
        ...
        style="height:300px"
      >
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Maiores ex quos
        culpa laboriosam error, quo quas voluptatum impedit consequuntur cum et
        reprehenderit soluta fugiat rem illo commodi fuga ratione aut?
      </div>
      <h3>Bài tập</h3>
      <p [ngStyle]="{ 'font-size': fontSize + 'px' }">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Labore enim
        perferendis facilis repellat qui iusto nobis facere ex tempore
        recusandae vero quo minus quisquam fuga illum dolorum, natus corporis
        quae.
      </p>
